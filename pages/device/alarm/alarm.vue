  ...
  <view class="app">
    ...
    <view class="options-section">
      ...
      <view class="button-area">
        ...
        <uni-button class="action-btn" @click="CZD">称重斗</uni-button>
      </view>
      <view class="button-area">
        <uni-button class="action-btn" @click="DZero">斗置零</uni-button>
        <uni-button class="action-btn" @click="clearError">故障清除</uni-button>
      </view>
    </view>
